...
def run_join(*, scheduler=None, tracker=None, auth_key=None, identity_key=None,
             ...
             max_shards=None, verify_routing=False, quiet: bool = False, tls=None,
    ...
    if verify_routing:
        print("[join] routing verification: on (re-fitting the shipped router from "
              "the public source on first task; refusing to train on a mismatch)")
